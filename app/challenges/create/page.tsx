                  ...
                  <div className="p-4 rounded-xl bg-[#91C687]/10 border border-[#91C687]/30">
                    ...
                    <div className="space-y-1.5 text-sm">
                      <div className="flex justify-between">
                        <span className="text-[#AFC2D5]">Total pool ({form.maxParticipants} x ${form.stakeAmount})</span>
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-[#AFC2D5] max-w-sm mx-auto leading-relaxed">
                    {form.name ? form.name + " is live. Stay consistent, hit your milestones, and take home the prize." : "Your challenge is live. Stay consistent, hit your milestones, and take home the prize."}
                  </p>
                </div>
                {friends.length > 0 && (
